...
<html lang="en">
  ...
  <span class="font-weight-bold text-primary ml-2 valueSpan2"></span>
    ...
    <p class="card-text"><h4>Cortina:</h4> </p>
     <div class="d-flex justify-content-center my-4">
  <div class="w-75">
    <input type="range" class="custom-range" id="customRange112" min="0" max="10">
  </div>
  <span class="font-weight-bold text-primary ml-2 valueSpan22"></span>
</div>
...
<div class="card">
  ...
  <span class="font-weight-bold text-primary ml-2 valueSpan5"></span>
    ...
    <p class="card-text"> <h4>Cortina:</h4> </p>
     <div class="d-flex justify-content-center my-4">
  <div class="w-75">
    <input type="range" class="custom-range" id="customRange6" min="0" max="10">
  </div>
...
<div class="card">
  ...
  <div class="w-75">
    <input type="range" class="custom-range" id="customRange3" min="16" max="32">
  </div>
  <span class="font-weight-bold text-primary ml-2 valueSpan3"></span>
    ...
    <p class="card-text"> <h4>Cortina:</h4> </p>
     <div class="d-flex justify-content-center my-4">
  <div class="w-75">
    <input type="range" class="custom-range" id="customRange4" min="0" max="10">
  </div>
...
<p class="card-text"><h4>Geladeira: </h4><div class="custom-control custom-switch">
    <input type="checkbox" class="custom-control-input" id="customSwitches8" checked>
  <label class="custom-control-label" for="customSwitches8"> </label>
</div></p> 
  
<p class="card-text"><h4>Freezer: </h4><div class="custom-control custom-switch">
    <input type="checkbox" class="custom-control-input" id="customSwitches9" checked>
  <label class="custom-control-label" for="customSwitches9"> </label>
</div></p> 
  </div>
